...
try:
    ...
    print("Warning: wandb not available, continuing without experiment tracking")
...
def main():
    ...
    parser.add_argument("-m", "--model_name", type=str, default="gpt-3.5-turbo", help="Model name")
